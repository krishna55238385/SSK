...
export const Footer: React.FC = () => {
  ...
  return (
    <footer ref={footerRef} className="w-full bg-[#291A00] relative mt-10 overflow-hidden flex justify-center py-16 lg:py-0 h-auto lg:h-[530px]">
      
      {/* Figma Frame 54 Container */}
      <div className="relative w-full max-w-[1200px] h-auto lg:h-[530px] shrink-0 px-6 lg:px-10 flex flex-col lg:block box-border">
        ...
        <div className="relative lg:absolute flex flex-col items-center lg:items-start z-10 w-full lg:w-[270px] lg:left-[40px] lg:top-[50px] footer-left-col">
          {/* Logo Block */}
          <div className="flex flex-col items-center lg:items-start gap-[4px] p-0 w-[170px] h-[116px] footer-logo-block">
            ...
            <span className="w-[170px] h-[21px] font-sans font-normal text-[12px] leading-[150%] flex items-center justify-center text-center tracking-[4.8px] uppercase text-[#E1C28E] shrink-0 footer-brand-text">
              Handlooms
            </span>
          </div>

          {/* Horizontal Divider (Logo) */}
          <div className="hidden lg:block relative footer-divider-logo mt-[16px]" style={{ height: '1px', width: '226px', background: 'linear-gradient(90deg, rgba(233, 195, 73, 0) 0%, #E9C349 50%, rgba(233, 195, 73, 0) 100%)' }}>
            {/* Background / Icon */}
          ...
          <div className="relative z-10 font-medium text-[20px] leading-[130%] text-[#FFFFFF] w-full lg:w-[270px] mt-6 lg:mt-[24px] text-center lg:text-left footer-motto" style={{ fontFamily: "'Playfair Display', serif" }}>
        ...
        <div className="relative lg:absolute flex flex-col md:flex-row justify-center items-center lg:items-start gap-12 md:gap-[90px] p-0 z-10 w-full lg:w-[544px] lg:left-[616px] lg:top-[50px] mb-12 lg:mb-0">
          
          {/* Frame 62 (Shop) */}
          <div className="flex flex-col justify-center items-center lg:items-start gap-[28px] shrink-0 w-full md:w-[194px] footer-shop-col">
            {/* Frame 52 (Badge) */}
            ...
            {/* Frame 61 (Links) */}
            <div className="flex flex-col items-center lg:items-start gap-[16px] shrink-0 w-full" style={{ height: '184px' }}>
          ...
          {/* Frame 76 (Contact) */}
          <div className="flex flex-col items-center lg:items-start gap-[33px] shrink-0 w-full md:w-[260px] footer-contact-col">
            {/* Frame 63 */}
            <div className="flex flex-col items-center lg:items-start gap-[28px] w-full shrink-0" style={{ height: '184px' }}>
              {/* Badge */}
              ...
              {/* Links */}
              <div className="flex flex-col items-center lg:items-start gap-[16px] shrink-0 w-full" style={{ height: '128px' }}>
                ...
                <div className="flex flex-row justify-center items-start gap-[8px] shrink-0" style={{ height: '48px' }}>
                  ...
                  <span className="font-sans font-normal text-[14px] leading-[150%] flex items-center text-center lg:text-left text-[#EEEEEE]" style={{ width: '174px' }}>Coimbatore, Tamil Nadu, India</span>
                </div>
              </div>
            </div>

            {/* Social Icons (Frame 75) */}
            <div className="flex flex-row items-center justify-center lg:justify-start gap-[32px] shrink-0 footer-social-icons" style={{ width: '160px', height: '32px' }}>
        ...
        {/* image 32 (Watermark) */}
        <div className="absolute z-0 pointer-events-none footer-watermark opacity-[0.13] top-[520px] lg:top-[270px]" style={{ width: '1500px', height: '200px', left: '50%', transform: 'translateX(-50%)' }}>
        ...
        <div className="relative lg:absolute z-10 footer-divider-bottom w-full lg:w-[976px] h-[1px] lg:left-[112px] lg:top-[470px] my-8 lg:my-0" style={{ background: 'linear-gradient(90deg, rgba(67, 51, 23, 0) 0%, rgba(67, 51, 23, 0.5) 50%, rgba(67, 51, 23, 0) 100%)', transform: 'matrix(1, 0, 0, -1, 0, 0)' }} />

        {/* Frame 8 (Copyright Text) */}
        <div className="relative lg:absolute flex justify-center items-center z-10 w-full lg:w-[363px] lg:left-[418.5px] lg:top-[490px] footer-copyright">
